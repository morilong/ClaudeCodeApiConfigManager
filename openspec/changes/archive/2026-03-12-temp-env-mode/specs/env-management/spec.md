...
### Requirement: Permanent environment variable by default

**Reason**: Default behavior changed to temporary mode for better user experience.

**Migration**: Use `ccm use <name> --persist` or `ccm use <name> -p` for permanent environment variables.
