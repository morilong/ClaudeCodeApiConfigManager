...
public static class Constants
{
    ...
    public static class Messages
    {
        ...
        public const string FirstRunDetected = "检测到这是您首次运行 ccm，我们将执行以下操作：";
        public const string InstallationComplete = "安装完成！";
        public const string UninstallComplete = "ccm 已卸载。如需重新安装，请再次运行程序。";
        public const string FileAlreadyExists = "已存在";
        public const string AskOverwrite = "是否覆盖? [y/N]:";
        public const string AskContinue = "是否继续? [y/N]:";
        public const string AskRemoveConfig = "是否同时删除配置文件? [y/N]:";
