...
public static class Constants
{
    ...
    public static class ShellMarkers
    {
        ...
        public const string CcmInitStart = "<ccm-init>";
        public const string CcmInitEnd = "</ccm-init>";
    }
    ...
    {
        public const string CcmFunctionName = "ccm";
    }
    ...
    {
        public const string WindowsEnvUpdate = "全局环境变量已更新。";
        public const string WindowsRestartHint = "打开新终端窗口 或 重启ClaudeCode程序 使更改生效。";
        public const string UnixEnvUpdate = "全局环境变量已更新。";
