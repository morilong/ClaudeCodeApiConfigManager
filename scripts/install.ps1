#
# ClaudeCodeApiConfigManager (ccm) 一键安装脚本 (PowerShell - Gitee 源)
# 适用于 Windows
#
# 用法: irm https://gitee.com/morilong/claude-code-api-config-manager/raw/master/scripts/install.ps1 | iex
#
...
function Get-LatestVersion {
    ...
    try {
        $response = Invoke-RestMethod -Uri "https://gitee.com/api/v5/repos/morilong/claude-code-api-config-manager/releases?page=1&per_page=1&direction=desc" -ErrorAction Stop
        ...
        Write-Error "无法从 Gitee API 获取版本信息"
        Write-Host ""
        Write-Host "请浏览器打开：" -ForegroundColor Yellow
        Write-Host "https://gitee.com/morilong/claude-code-api-config-manager/releases" -ForegroundColor Cyan
...
function Download-AndExtract {
    ...
    $downloadUrl = "https://gitee.com/morilong/claude-code-api-config-manager/releases/download/v${Version}/${filename}"
